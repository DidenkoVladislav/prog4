...
void setter_matrix2d(Matrix2d *m, int is_edit, size_t rows, size_t cols, TYPE_VAR type);
...
double **getminor(TAG_VAR **arr, TYPE_VAR type, int rows, int cols, int row, int col);
